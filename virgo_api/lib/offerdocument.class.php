 ...
 *
 */
class OfferDocument extends AObject {
	...
	public function GetImgSrc($customSize, $basicWatermark, $additionalWatermark, $kadruj = false){
		return OfferDocuments::GetImg($this, $customSize, $basicWatermark, $additionalWatermark, $kadruj);
	}
	...
	public function __construct($id, $OfferId, $InvestmentId, $Filename, $Description, $Type, $FotoId){
            $this->SetId($id);
